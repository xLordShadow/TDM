...
use pocketmine\event\player\{PlayerQuitEvent,PlayerCommandPreprocessEvent, PlayerInteractEvent, PlayerDropItemEvent, PlayerJoinEvent, PlayerChatEvent};
...
class EventListener implements Listener{
  ...
  public function onDrop(PLayerDropItemEvent $event){
	...
	public function onChat(PlayerChatEvent $event){
		...
		$event->setFormat(TextFormat::GRAY . $player->getName() . ": " . $message);
	}
